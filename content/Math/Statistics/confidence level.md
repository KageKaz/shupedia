...
> [!example] 
> If we are give confidence level, we can find sample size necessary to achieve it by assuming the [[margin of error]] is as big as it possibly can be and solving for sample size.
